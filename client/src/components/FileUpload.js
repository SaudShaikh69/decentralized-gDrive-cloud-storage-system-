...
const FileUpload = ({ contract, account, provider, setModalFileOpen }) => {
  console.log("yes")
  ...
  const handleSubmit = async (e) => {
    ...
    if (file) {
      try {
        ...
        // Display(contract, account).getdata()
      } catch (e) {
  ...
  return (
    ...
    <div className="modalBackground">
      <div className="modalContainer" id="File_modal">
        {!fileName &&
          <div className="title">Upload image</div>
        }
        {fileName &&
          <div className="title">Image: {fileName}</div>
        }
        <div className="body">
          <div className="top">
            <form className="form" onSubmit={handleSubmit}>
